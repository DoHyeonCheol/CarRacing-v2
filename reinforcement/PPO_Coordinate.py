...
model = PPO.load("./Training/Saved_Models/PPO_car_best_Model/best_model.zip")

log_path = os.path.join('./Real/')
os.makedirs(log_path, exist_ok=True)

log_file_path = os.path.join(log_path, 'PPO.txt')
...
with open(log_file_path, 'w') as log_file:
    while episode_count < max_episodes:
        ...
        while not done:
            ...
            # 좌표를 리스트에 추가
            coordinates.append(f"{normalized_x}, {normalized_y}")
